...
SVG_PATH = OUTDIR / "rtdetr_swinv2_tiny_b2_p3_mdhifi_0621_b5_stepwise_lateral_p4mdhifi.svg"
DRAWIO_PATH = OUTDIR / "rtdetr_swinv2_tiny_b2_p3_mdhifi_0621_b5_stepwise_lateral_p4mdhifi.drawio"

VARIANT = Variant(
    title="B2 P3-MDHIFI 0621 B5 Stepwise Lateral P4-MDHIFI",
    page_name="0621-b5-stepwise-lateral-p4mdhifi",
    svg_name=SVG_PATH.name,
    run_name="rtdetr-swinv2-tiny-unfreeze-last3-ema-b2-p3-mdhifi-0621-b5-stepwise-lateral-p4mdhifi-12k4k4k-e100",
    yaml_name="rtdetr-swinv2-tiny-last3-pretrained-ema-b2-p3-mdhifi-0621-b5-stepwise-lateral-p4mdhifi.yaml",
    note="B5 keeps the B2 P3 top-down path, but uses P4 lateral MDHIFI: Y4 -> P4m; P4m feeds Up(P4m) to P3 and A5 to P5.",
)
...
def edges() -> list[Edge]:
    return [
        ...
        Edge("td_p4", "y4"),
        Edge("y4", "p4m"),
        Edge("p4m", "p3_out", points=((1180, 370), (985, 370))),
        Edge("p3_proj", "p3m"),
        Edge("p3m", "p3_out"),
        ...
        Edge("p4_out", "p5_down"),
        Edge("p5_down", "p5_out"),
        Edge("p4m", "a5", color=RED, dashed=True, points=((1160, 360), (520, 360), (520, 690))),
...
def write_drawio() -> Path:
    page_id = "b5_stepwise_lateral_p4mdhifi"
    cells = [
