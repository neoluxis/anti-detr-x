...
SVG_PATH = OUTDIR / "test00001_principle.svg"
DRAWIO_PATH = OUTDIR / "test00001_principle.drawio"

VARIANT = Variant(
    title="DETR0627 Test00001 Principle",
    page_name="detr0627-test00001",
...
def edges() -> list[Edge]:
    return [
        ...
        Edge("y4", "p4_out", points=((1425, 303), (1425, 535), (1140, 535))),
...
def write_svg() -> Path:
    box_map = boxes()
    parts = [
        '<svg xmlns="http://www.w3.org/2000/svg" width="1900" height="960" viewBox="0 0 1900 960">',
        "<defs>",
        '<marker id="arrow" markerWidth="12" markerHeight="12" refX="10" refY="6" orient="auto">',
        '<path d="M0,0 L12,6 L0,12 z" fill="#41576b"/>',
        "</marker>",
        "</defs>",
        f'<rect x="0" y="0" width="1900" height="960" fill="{BG}"/>',
        f'<text x="950" y="42" text-anchor="middle" font-family="Helvetica, Arial, sans-serif" font-size="26" font-weight="700" fill="#16222d">{escape(VARIANT.title)}</text>',
        f'<text x="950" y="68" text-anchor="middle" font-family="Helvetica, Arial, sans-serif" font-size="13" fill="#3b4a57">Run: {escape(VARIANT.run_name)}</text>',
        f'<text x="950" y="86" text-anchor="middle" font-family="Helvetica, Arial, sans-serif" font-size="13" fill="#3b4a57">YAML: {escape(VARIANT.yaml_name)}</text>',
    ...
    for box in box_map.values():
        svg_box(parts, box)
    svg_text(parts, 950, 915, VARIANT.note, 15, "#344756")
    parts.append("</svg>")
...
def write_drawio() -> Path:
    ...
    content = (
        ...
        'arrows="1" fold="1" page="1" pageScale="1" pageWidth="1900" pageHeight="960" math="0" shadow="0">\n'
        f"<root>\n{root}\n</root>\n"
        "</mxGraphModel>\n"
        "</diagram>\n"
        "</mxfile>\n"
